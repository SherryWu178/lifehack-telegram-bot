...
keyboard = [
    [
        InlineKeyboardButton("Button 1", switch_inline_query_current_chat='/add ', message_id= 12345}),
        InlineKeyboardButton("Button 2", switch_inline_query_current_chat='/remove ', message_id= 12345}),
    ]
]
